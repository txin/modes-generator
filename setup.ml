...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7c79bc54c72a2e60db5f5efb5718e3de) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build ["-use-ocamlfind"; "-cflags"; "-safe-string"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/amaloz/modes-generator";
          synopsis = "Mode of operation generator";
          description =
            Some
              [
                 OASISText.Para
                   "This program implements the mode of operation generator as detailed in: \"Automated Analysis and Synthesis of Block-Cipher Modes of Operation.\" Alex J. Malozemoff, Jonathan Katz, and Matthew D. Green. IEEE Computer Security Foundations Symposium, Vienna, Austria, July 19-22, 2014."
              ];
          categories = [];
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "src/mocheck.ml"});
               Executable
                 ({
                     cs_name = "mosynth";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "src/mosynth.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "JR=\024\230\029P\176\218\231NX\202\217\176\163";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
